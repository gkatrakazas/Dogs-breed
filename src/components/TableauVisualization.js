      ...
      <div className="row">
        ...
        <div className="tableau-viz">
            ...
            <div className='conclutions'>
              ...
              <p >➤ ‘’<span className='brown'>Brave’’</span> and ‘’<span className='brown'>calm’’</span> character traits appear only <strong>once</strong> among all 103 dog breeds but they have the most negative effect on average <strong>longevity</strong>. The most interesting fact is that these two character traits are very different from each other. For example a brave dog could possibly risk its life, but a calm dog may not do the same. </p>

              <br></br>
              <h4 style={{fontWeight:'600'}} >How these data visualizations could help the users</h4>
              <p >These data visualizations could help the users, who already have a dog (or dogs), to see the corresponding character traits and health problems of their dog (or dogs), if they know their longevity and their height.  It could also help someone who wants to get a dog (or dogs) to carefully examine its respective character traits and health problems based on its corresponding longevity and height. So he could make the right decision and he could be better prepared for the new family member!</p>
