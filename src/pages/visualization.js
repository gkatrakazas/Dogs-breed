...
function visualization() {
  return (
    ...
    <div id="visualization">
      ...
      <iframe title="Chart Visualization" width="400" height="300" src='https://public.tableau.com/views/Dog-breeds-visualization/Dashboard1?:language=en-US&:display_count=n&:origin=viz_share_link'></iframe>
