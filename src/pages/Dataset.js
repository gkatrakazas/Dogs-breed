    ...
    <div id="dataset">
      ...
      <div className="dataset-container">
        ...
        Keep that in mind, in order to prepare our dataset for analysis and visualization, we conducted several preprocessing steps. Firstly, we addressed duplicate entries by identifying breeds with multiple occurrences and merged their data. This ensured that each breed had a single representative entry, avoiding redundancy in our dataset.
          ...
          <br></br>
          We have also taken the initiative to ensure better compatibility with visualization tools such as Tableau by making adjustments to the names of certain countries 'Country of origin' in the dataset.This allows for smoother integration and seamless presentation of the data. Another preprocessing step is the creation of two new columns one for health problems and one for character traits ,through pivot in Tableau for example, where each row reports if the corresponding health problem or character trait is the health problem or the character trait of the respective dog breed.
          <br></br>
          Also in order to compare better character traits and health problems, we grouped (for example with groups of pivot variables in Tableau) all health problems and character traits based on longevity into the following categories:  ‘’8-11 yrs‘’,  ‘’11-12 yrs‘’,  ‘’12-13 yrs‘’ and ‘’13-14 yrs‘’. So, it is easier to understand which combinations of character traits and health problems contribute to a longer longevity for the dog breeds.
          <br></br>
          These two last preprocessing steps are very helpful, because the effect of health problems and character traits on dog breed longevity become more clear and finally the dashboards that are shown in the “Visualization” page of the website could be created easily.
          <br></br>
