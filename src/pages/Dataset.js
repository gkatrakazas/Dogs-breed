  ...
  return (
    <div id="dataset">
      ...
      <div className="dataset-container">
        ...
        <p>
        The basic challenge for this dataset is that the qualitative variables such as character traits, health problems, fur color are much more than the quantitative variables such as height and longevity, so the visualization becomes more difficult.
        <br></br>
